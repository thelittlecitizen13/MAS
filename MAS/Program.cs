    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // Screen screen32 = new Screen("Samsung 32", "32inch 4K Screen", 114);//
            ...
            //Auction appleOfficeAuction = new Auction(AppleTown, DateTime.Now.AddSeconds(20), 1200, 100);
            //Auction assaHomeAuction = new Auction(AssaHome, DateTime.Now.AddSeconds(20), 1000, 80);
            //Auction screenAuction77 = new Auction(screen77, DateTime.Now.AddSeconds(30), 600, 10);
            ...
            //MamasAuction.Auctions.Add(assaHomeAuction);
            //MamasAuction.Auctions.Add(appleOfficeAuction);
